...
Version 0.7.1. This document explains the scientific position of scNoiseMeter. For implementation details see [methods_annotated.md](methods_annotated.md); for command and output reference see [documentation.md](documentation.md).
